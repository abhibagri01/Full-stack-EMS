            ...
            {initialData.isDeleted ?(
                <div className='pt-2'>
                    <div className='p-4 bg-rose-50 border border-rose-200 rounded-xl text-center'>
                        <p className='text-rose-600 font-medium tracking-tight'>This account has been deleted</p>
                        <p className='text-sm text-rose-500 mt-0.5'>You cannot update your profile.</p>
                    </div>
                </div>
            ):(
