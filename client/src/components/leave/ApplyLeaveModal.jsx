        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="mb-4">
                ...
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    <div>
                        <span className='block text-xs text-slate-400 mb-1'>End Date</span>
            ...
            <div>
                ...
                <textarea name="reason" required className='resize-none' placeholder="Provide a brief reason for your leave request." rows={3} />
            </div>
